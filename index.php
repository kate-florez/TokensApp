            ...
            <div class="container header">
                ...
                <div class="row top-block-pad">
                    ...
                    <div class="col-lg-8 top-head">
                        <div class="nav-content">
                            <h1 class="title-head">
                               Set New Free Communication Traditions
                            </h1>
                ...
                <div class="row">
                    <div class="col-lg-3 about-icon one-about-icon">
                        ...
                        <h1>Trendy Design</h1>
                        <span>Appealing and stylish design developed for your comfy chats.</span>
                    </div>
                    <div class="col-lg-3 about-icon two-about-icon">
                        <img src="img/download.png">
                        <h1>One-touch screen</h1>
                        <span>Functional and easy to operate interface for all your needs.</span>
                    </div>
                    <div class="col-lg-3 about-icon one-about-icon">
                        <img src="img/people.png">
                        <h1>No boundaries</h1>
                        <span>Send messages to all your friends to any device. They will 100% get it.</span>
                    </div>
                    <div class="col-lg-3 about-icon two-about-icon">
                        <img src="img/groups.png">
                        <h1>Get socialized</h1>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 comfortable-title">
                        <h2>
                            What part of yin-yang contradiction you choose for today with our Bright Vs Dark feature?
                        </h2>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 comfortable-title">
                        <h2>
                           Choose your Bright Vs Dark version 
                        </h2>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row ios-titles">
                    <div class="col-lg-6 col-lg-offset-3">
                        <h3>Let’s dive in and explore!</h3>
        ...
        <section id="get-app" class="get-app-section">
            <div class="container">
                ...
                <div id="support" class="row ios-titles">
                    <div class="col-lg-6 col-lg-offset-3 get-app-titles">
                        <h1>Support</h1>
                        <h3 class="h3-white">Question or issues? Let us know.</h3>
                    </div>
                </div>
